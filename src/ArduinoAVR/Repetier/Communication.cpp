...
FSTRINGVALUE(Com::tEPRzThreadLeadPitch,"Z lead pitch [mm]")
FSTRINGVALUE(Com::tEPRzThreadLeadCorrAmount,"Z lead corr amount [mm]")
FSTRINGVALUE(Com::tEPRzThreadLeadCorrPhase,"Z lead corr phase [degree]")
